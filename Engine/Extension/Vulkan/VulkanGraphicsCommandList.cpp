...
void yuki::VulkanGraphicsCommandList::begin()
{
...
void yuki::VulkanGraphicsCommandList::bindPipeline(GraphicsPipeline *pipeline)
{
    VulkanGraphicsPipeline *vulkan_pipeline = dynamic_cast<VulkanGraphicsPipeline*>(pipeline);
...
void yuki::VulkanGraphicsCommandList::bindVertexBuffer(uint32_t slot, GraphicsBuffer *buffer)
{
    VulkanBuffer *vulkan_buffer = dynamic_cast<VulkanBuffer*>(buffer);
...
void yuki::VulkanGraphicsCommandList::_setAttachments(const std::vector<GraphicsImage *> &attachments)
{
    mImageViews.clear();
    mClearColors.clear();
