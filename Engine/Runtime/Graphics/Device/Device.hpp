...
public:
    ...
    virtual std::unique_ptr<class Pipeline> createPipeline(
        const struct PipelineCreateInfo &info) = 0;
    virtual std::unique_ptr<class FrameController> createFrameController(
        size_t num_frames) = 0;
