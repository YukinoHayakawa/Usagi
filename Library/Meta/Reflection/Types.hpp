...
template <typename... Ts> consteval auto sorted_types_by_names()
{
    return sorted_types<^^std::meta::display_string_of, Ts...>();
}

template <typename... Ts> consteval auto unique_type_list_sorted_by_names()
{
...
template <typename T, typename... Ts> consteval bool is_type_in_list()
{
...
{
template <typename> struct _meta_type_x
{
};
