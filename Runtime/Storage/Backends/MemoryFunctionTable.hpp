...
{
    ExpectedRuntimeValue<void *> (*map_view)(
        NativeFileHandle file, FileOpenMode mode, std::uint64_t offset,
        std::size_t size, std::size_t commit_size,
        void *base_address_hint) noexcept;
    ExpectedRuntimeValue<void> (*unmap_view)(
        void *base_address, std::size_t size) noexcept;
    ExpectedRuntimeValue<void *> (*remap_view)(
        void *base_address, std::size_t old_size,
        std::size_t new_size) noexcept;
    ExpectedRuntimeValue<void> (*commit_pages)(
        void *address, std::size_t size) noexcept;
    ExpectedRuntimeValue<void> (*decommit_pages)(
        void *address, std::size_t size) noexcept;
    ExpectedRuntimeValue<void> (*lock_pages)(
        void *address, std::size_t size) noexcept;
    ExpectedRuntimeValue<void> (*unlock_pages)(
        void *address, std::size_t size) noexcept;
    ExpectedRuntimeValue<void> (*zero_pages)(
        void *address, std::size_t size) noexcept;
    ExpectedRuntimeValue<bool> (*is_resident)(
        const void *address, std::size_t size) noexcept;
    ExpectedRuntimeValue<void> (*prefetch)(
        const void *address, std::size_t size) noexcept;
    ExpectedRuntimeValue<void> (*offer)(
        const void *address, std::size_t size) noexcept;
    ExpectedRuntimeValue<void> (*flush)(
        const void *address, std::size_t size) noexcept;
    ExpectedRuntimeValue<void> (*copy_memory)(
        void *dst, const void *src, std::size_t size) noexcept;
    ExpectedRuntimeValue<void> (*move_memory)(
        void *dst, const void *src, std::size_t size) noexcept;
};
