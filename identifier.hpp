...
*/
#define YUKI_CANONICAL_CLASS_ID(_namespaces, _class) ::YUKI_INFIX_JOIN(YUKI_OP_SCOPE YUKI_TAIL_UNPACK _namespaces, _class)
...
#define YUKI_USE_NAMESPACE(_namespaces) \
    ...
    BOOST_PP_IF( \
        ...
        BOOST_PP_EMPTY(), \
        YUKI_UNPACK(using namespace ::YUKI_INFIX_JOIN(YUKI_OP_SCOPE YUKI_TAIL_UNPACK _namespaces)) \
    ) \
/**/
